...
export function classifyAudit(operation: AuthorizationContext["operation"], decision: AuthorizationDecision): AuditClassification {
  ...
  return ["team:manage", "career:write", "consent:manage", "portfolio:share", "scouting:opportunity", "communication:private", "role:switch", "role:self-grant"].includes(operation) ? "AUDIT_ON_MUTATION" : "SECURITY_LOG_ONLY";
}
