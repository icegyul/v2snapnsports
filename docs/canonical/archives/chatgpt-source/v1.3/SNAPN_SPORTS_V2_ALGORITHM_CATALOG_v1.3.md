...
| A36 | Earthus Context Fetch & Fallback | P1 OPTIONAL | Earthus Context를 일정/경기에 soft dependency로 부착하고 장애 시 안전하게 fallback |
| A37 | Earthus Context Projection | P1 OPTIONAL | Earthus 환경정보를 역할/화면별 정보밀도에 맞게 투영 |
| A38 | Career Passport Event Normalization | P0/P1 | 다양한 원천 활동을 provenance가 있는 CareerEvent로 표준화 |
| A39 | Career Passport Chapter & Milestone Assembly | P0/P1 | CareerEvent를 시즌 Chapter/마일스톤으로 조립 |
| A40 | Scouting Visibility & Consent Eligibility | P1/P2 | 선수의 스카우팅 공개 가능 여부와 공개 필드를 동의 기반으로 결정 |
| A41 | Opportunity Eligibility Matching | P1/P2 | 명시된 기회 조건에 대한 투명한 hard eligibility 매칭 |
| A42 | Communication Recipient & Channel Resolution | P0/P1 | 팀/보호자/역할 관계에 맞는 실제 수신자와 채널을 계산 |
| A43 | Communication Delivery & Thread Dedupe | P0/P1 | canonical message 저장과 delivery를 분리하고 중복 thread/message 방지 |
| A44 | Safeguarding Interaction Gate | P0 | 미성년 대상 검색·연락·공유 전에 공통 hard safety policy 적용 |
| A45 | Safety Incident Triage & Escalation | P0 | 신고를 단계별 incident/restriction/review workflow로 처리 |
