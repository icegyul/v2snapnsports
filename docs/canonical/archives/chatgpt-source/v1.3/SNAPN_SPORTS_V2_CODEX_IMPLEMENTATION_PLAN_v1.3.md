...
## Phase 1 — Identity / Role / Credential / Permission / Safeguarding
...
7. E40 Safeguarding baseline policy + block/report skeleton.
...
- external agent/referee -> minor direct DM deny.

## Phase 2 — Legacy Adapter / Community Parity / Communication / Offline / Privacy
...
- E39 operational communication thread/message/announcement core + safeguarding check.

### Gate
- V2 Community의 기능 누락 0 또는 명시적 exception list.
- operational Communication이 Community visibility/store로 섞이는 경로 0.
...
- E39 advanced Communication: opportunity-mediated thread, role-specific inbox, correction/read UX.
