# SNAPN SPORTS V2 FRONTEND SCAFFOLD RULES v1.7
...
- Visual surfaces use semantic Graphite tokens only; no dark-navy reintroduction and no per-component arbitrary hex values.
- Adjacent dark surfaces require a visible luminance step and/or semantic border.
- High Contrast Graphite is a display/accessibility profile, not a separate product experience.
