// V13 acceptance verification entrypoint; package lock synchronized for Three.js renderer.
...
export { createStadiumWebglRenderer } from "./stadiumWebglV13";
export type { StadiumWebglRenderer } from "./stadiumWebglV13";
