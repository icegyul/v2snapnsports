// V14.2 PBR Base Stadium acceptance entrypoint.
...
export { createStadiumWebglRenderer } from "./stadiumWebglV142";
export type { StadiumWebglRenderer } from "./stadiumWebglV142";
